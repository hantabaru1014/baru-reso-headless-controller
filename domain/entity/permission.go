...
var AllPermissionKeys = []PermissionKeyDef{
	...
	{Key: PermKey_AccountRead, Description: "View account list / detail / storage info", Scope: RoleScope_Normal},
	{Key: PermKey_AccountWrite, Description: "Create / update credentials / delete accounts", Scope: RoleScope_Normal},
	{Key: PermKey_AccountUse, Description: "Use an account to start a session", Scope: RoleScope_Normal},
