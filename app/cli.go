...
func NewCli(queries *db.Queries, uu *usecase.UserUsecase, hu *usecase.HeadlessHostUsecase, sou *usecase.ScheduledSessionOperationUsecase, skyfrostClient skyfrost.Client) *Cli {
	rootCmd := &cobra.Command{
		Use:   "brhcli",
