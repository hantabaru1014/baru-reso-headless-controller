...
func InitializeServer(cfg *config.EnvConfig) (*Server, error) {
	...
	dockerHostConnector := hostconnector.NewDockerHostConnector(dockerConfig, grpcConfig, serverConfig)
	...
	resoniteVersionUsecase := usecase.NewResoniteVersionUsecase(resoniteVersionRepository, builder, dockerHostConnector, resoniteBuildConfig)
